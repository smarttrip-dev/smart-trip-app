...
async function seed() {
  ...
  const inventoryData = [
    ...
    { vendor: vendor1._id, name: 'Sigiriya Rock Fortress Day Tour', type: 'activity', description: 'Full-day guided tour to the iconic Sigiriya Rock Fortress with lunch.', price: 12500, capacity: 20, availableCount: 18, location: 'Sigiriya', amenities: ['Lunch included', 'English guide', 'Transport', 'Entry tickets'], images: ['https://images.unsplash.com/photo-1588416936097-41850ab3d86d?w=800'] },
    { vendor: vendor1._id, name: 'Kandy Cultural Triangle Tour (3D/2N)', type: 'package', description: 'Explore Kandy, Dambulla and Polonnaruwa in a 3-day cultural package.', price: 45000, capacity: 10, availableCount: 8, location: 'Kandy', amenities: ['Hotel stay', 'All meals', 'Guide', 'AC transport', 'Entry tickets'], images: ['https://images.unsplash.com/photo-1616128417859-3a984dd35f02?w=800'] },
    { vendor: vendor1._id, name: 'Ella Hill Country Train & Hike (2D/1N)', type: 'package', description: 'Scenic train ride from Kandy to Ella + hike to Little Adam\'s Peak.', price: 32000, capacity: 15, availableCount: 12, location: 'Ella', amenities: ['Train ticket', 'Guesthouse stay', 'Breakfast', 'Hiking guide'], images: ['https://images.unsplash.com/photo-1579546929518-9e396f3cc809?w=800'] },
    
    // Vendor 2: Amaya Coastal Tours (Travel Agency)
    { vendor: vendor2._id, name: 'Mirissa Whale Watching Cruise', type: 'activity', description: 'Morning whale watching cruise off the south coast with breakfast on board.', price: 8500, capacity: 30, availableCount: 25, location: 'Mirissa', amenities: ['Breakfast', 'Life jackets', 'Marine biologist guide', 'Photos'], images: ['https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=800'] },
    ...
    { vendor: vendor4._id, name: 'Jeep Safari at Yala National Park (Full Day)', type: 'activity', description: 'Full-day safari tour with experienced driver and wildlife expert.', price: 15000, capacity: 4, availableCount: 3, location: 'Yala', amenities: ['Expert guide', 'Breakfast & lunch', 'Binoculars', 'Photography assist'], images: ['https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800'] },
    { vendor: vendor4._id, name: 'AC Jeep Rental (4WD per day)', type: 'transport', description: 'Comfortable 4WD AC jeep rental with fuel included for island-wide travel.', price: 12000, capacity: 5, availableCount: 4, location: 'Colombo', amenities: ['AC', 'GPS', 'Fuel included', 'Insurance', 'Experienced driver'], images: [] },
    
    // Vendor 5: Local Guide Services
    { vendor: vendor5._id, name: 'Ella Rock Hiking Tour with Local Guide', type: 'activity', description: 'Guided hike to Ella Rock with stunning tea plantation views and breakfast.', price: 5000, capacity: 15, availableCount: 12, location: 'Ella', amenities: ['Expert guide', 'Breakfast', 'Water & snacks', 'Photos'], images: ['https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800'] },
    { vendor: vendor5._id, name: 'Cultural Heritage Walking Tour (Dambulla)', type: 'activity', description: 'Full-day tour exploring cave temples and ancient heritage sites.', price: 8000, capacity: 12, availableCount: 10, location: 'Dambulla', amenities: ['Licensed guide', 'Lunch', 'Temple entry', 'Historical insights'], images: [] },
    
    // Vendor 6: Adventure Extreme Sports
    { vendor: vendor6._id, name: 'White Water Rafting (Grade III-IV)', type: 'activity', description: 'Thrilling rafting adventure on Kelani River with safety equipment.', price: 6500, capacity: 8, availableCount: 6, location: 'Colombo', amenities: ['Guide', 'Safety gear', 'Lunch', 'Photos', 'Insurance'], images: ['https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=800'] },
    { vendor: vendor6._id, name: 'Paragliding Experience (30 mins)', type: 'activity', description: 'Thrilling tandem paragliding with experienced pilot over scenic landscape.', price: 9500, capacity: 6, availableCount: 4, location: 'Sigiriya', amenities: ['Pilot', 'Safety gear', 'GoPro video', 'Certificate'], images: [] },
    
    // Vendor 7: The Spice Trail Restaurant
    { vendor: vendor7._id, name: 'Fine Dining Multi-Course Meal (per person)', type: 'meal', description: 'Chef\'s special 5-course Sri Lankan fusion dinner with wine pairing.', price: 4500, capacity: 50, availableCount: 30, location: 'Colombo', amenities: ['Wine pairing', 'Vegan options', 'Special dietary', 'Ambiance lighting'], images: [] },
    { vendor: vendor7._id, name: 'Cooking Class with Chef Priya (3 hours)', type: 'activity', description: 'Learn to cook authentic Sri Lankan curry and rice dishes.', price: 8500, capacity: 12, availableCount: 8, location: 'Colombo', amenities: ['All ingredients', 'Equipment provided', 'Recipe booklet', 'Lunch included'], images: [] },
  ...
  await ConfigItineraryItem.insertMany([
    ...
    // ACTIVITIES (distributed across destinations to match ConfigDestination locations)
    ...
    { type: 'activity', name: 'Tea Plantation Tour', location: 'Nuwara Eliya', category: 'Nature', price: 4000, duration: '4 hours', available: true },
    { type: 'activity', name: 'Spice Garden Tour', location: 'Dambulla', category: 'Cultural', price: 2500, duration: '2 hours', available: true },
    { type: 'activity', name: 'Gem Museum Visit', location: 'Colombo', category: 'Cultural', price: 1000, duration: '1 hour', available: true },
    { type: 'activity', name: 'Elephant Orphanage', location: 'Sigiriya', category: 'Nature', price: 5000, duration: '3 hours', available: true },
    { type: 'activity', name: 'Cooking Class', location: 'Colombo', category: 'Food', price: 4500, duration: '3 hours', available: true },
    { type: 'activity', name: 'Batik Workshop', location: 'Colombo', category: 'Cultural', price: 3000, duration: '2 hours', available: false },
    { type: 'activity', name: 'White Water Rafting', location: 'Colombo', category: 'Adventure', price: 6000, duration: '4 hours', available: true },
